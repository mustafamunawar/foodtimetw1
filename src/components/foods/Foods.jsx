...
function Foods({ type, addToCart }) {
  ...
  if(type=='Breakfast')
  {
   ...
   sub_intro='Enjoy a delightful breakfast with our carefully-selected breakfest items.'
  }
   if(type=='Dinner')
  {
    intro='Enjoy a scrumptious dinner with our mouth-watering dinner menu. Enjoy a full-course meal with our wide selection of only the highest-quality items.'
  ...
  return (
    ...
    >
      ...
      <h1 className="text-5xl   font-light max-w-5xl  opacity-60  text-center mt-8">{intro}</h1>
      <h1 className="text-4xl   font-thin max-w-3xl  opacity-60  text-center mt-3 mb-16">{sub_intro}</h1>
